...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   */
  queryGetInfo = (creator: string, denom: string, params: RequestParams = {}) =>
    this.request<TestQueryGetInfoResponse, RpcStatus>({
      path: `/sujine/test/test/get_info/${creator}/${denom}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/sujine/test/test/params
   */
